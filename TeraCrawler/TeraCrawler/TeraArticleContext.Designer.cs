...
// Code is generated on: 2014-09-04 오후 9:48:05
//
...
namespace DataContext
{
    ...
    public partial class TeraDataContext : Devart.Data.Linq.DataContext
    {
        ...
        public Devart.Data.Linq.Table<CheckPoint> CheckPoints
        {
            get
            {
...
namespace DataContext
{
    ...
    public partial class Article : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for ArticleAutoId in the schema.
        /// </summary>
        [Column(Storage = "_ArticleAutoId", CanBeNull = false, DbType = "int(9) NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        ...
        /// </summary>
        [Column(Storage = "_CategoryId", CanBeNull = false, DbType = "int(9) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_ArticleId", CanBeNull = false, DbType = "int(9) NOT NULL")]
        ...
        /// </summary>
        [Column(Storage = "_Keywords", DbType = "longtext NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    /// <summary>
    /// There are no comments for DataContext.Comment in the schema.
    /// </summary>
    ...
    public partial class Comment : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for CommentAutoId in the schema.
        /// </summary>
        [Column(Storage = "_CommentAutoId", CanBeNull = false, DbType = "int(9) NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        ...
        /// </summary>
        [Column(Storage = "_CommentId", DbType = "int(9) NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// There are no comments for ArticleAutoId in the schema.
        /// </summary>
        [Column(Storage = "_ArticleAutoId", CanBeNull = false, DbType = "int(9) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public int ArticleAutoId
        {
            get
            {
    ...
    /// <summary>
    /// There are no comments for DataContext.CheckPoint in the schema.
    /// </summary>
    [Table(Name = @"mastermind.CheckPoints")]
    public partial class CheckPoint : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnValidate(ChangeAction action);
        partial void OnCreated();
        partial void OnAnalysisPhaseChanging(AnalysisPhase value);
        ...
        /// </summary>
        [Column(Storage = "_AnalysisPhase", CanBeNull = false, DbType = "int(9) NOT NULL", IsPrimaryKey = true)]
        ...
        /// <summary>
        /// There are no comments for ProcessedArticleId in the schema.
        /// </summary>
        [Column(Storage = "_ProcessedArticleId", CanBeNull = false, DbType = "int(9) NOT NULL", UpdateCheck = UpdateCheck.Never)]
